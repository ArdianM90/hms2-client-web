    ...
    return (
        <Box>
            ...
            <Box sx={{display: "flex", gap: 3, alignItems: "flex-start"}}>
                ...
                >
                    <ReservationSummaryCard offer={offer} startDate={startDate} endDate={endDate}/>
                </Box>
                ...
                <Box sx={{ flex: 1, minWidth: 0 }}>
                    ...
                    <Stack spacing={2}>
                        {offer.rooms.map((room, index) => (
                            <ReservationRoomCard key={index} room={room} roomNumber={index + 1}/>
                        ))}
                    </Stack>
                </Box>
            </Box>
